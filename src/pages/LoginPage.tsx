    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4 sm:p-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-2xl bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl p-6 sm:p-8 space-y-6">
        ...
        {pendingGoogleUser ? (
          ...
          /* PRIMARY AUTHENTICATION: AUTHORIZED GOOGLE SIGN-IN */
              ...
              <div className="space-y-4 relative z-10">
                ...
                <div className="p-4 rounded-xl bg-slate-950/80 border border-slate-800 space-y-2.5 text-xs text-slate-300">
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400 mt-0.5">
                        শুধুমাত্র এই একটি জিমেইল সম্পূর্ণ অ্যাডমিন ক্ষমতার অধিকারী। লগইন করলেই স্বয়ংক্রিয়ভাবে পূর্ণ নিয়ন্ত্রণ পাবেন।
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-2.5">
                    ...
                    <div>
                      <span className="font-bold text-amber-300">অন্যান্য যেকোনো জিমেইল: </span>
                      <span className="text-slate-300">
                        সরাসরি কাউকে প্রবেশ করতে দেওয়া হবে না। লগইন করলে তা অনুমোদনের অপেক্ষায় থাকবে এবং শুধুমাত্র মাস্টার অ্যাডমিন চাইলে তাকে নির্দিষ্ট রোল (CO, RSM, BSM, Offr) দিয়ে অনুমোদন দিতে পারবেন। বাকি সবাই সরাসরি ব্লক থাকবে।
                      </span>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-slate-400 text-[11px]">
                  {systemSettings?.allowGuestMode === false
                    ...
                    : 'জিমেইল অনুমোদন ছাড়া কোনো পরিবর্তন না করে শুধু তথ্য দেখার জন্য প্রবেশ করুন।'}
                </p>
              </div>
          ...
          <div className="relative w-full max-w-lg bg-slate-900 border border-amber-500/50 rounded-2xl p-6 sm:p-7 shadow-2xl space-y-5 animate-in fade-in zoom-in-95">
            ...
            <div className="bg-gradient-to-r from-emerald-950/60 via-slate-900 to-slate-900 border border-emerald-500/40 rounded-xl p-4 space-y-2">
              <div className="flex items-center gap-2 text-emerald-400 text-xs font-bold font-mono">
                ...
                <span>তাত্ক্ষণিক অ্যাডমিন অ্যাক্সেস (Emergency Bypass)</span>
              </div>
              ...
              >
                ...
                <span>Continue as Master Admin (Emergency Bypass)</span>
